...
analysis to a model as 47 exact-schema operations — decompile, cross-reference,
...
| Group | Operations |
|---|---|
| **Session** | `open_binary`, `close_session`, `session_get`, `session_list`, `session_switch`, `session_state`, `session_status`, `session_health` |

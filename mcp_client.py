...
class MCPClient:
    def __init__(self, server_cmd=None, env=None, cache_dir=None):
        ...
        if env:
            run_env.update(env)
        run_env["IDADIR"] = run_env.get("IDADIR", "/home/REDACTED/ida-pro-9.2")
        run_env["IDA_MCP_IDAT"] = run_env.get("IDA_MCP_IDAT", "/home/REDACTED/ida-pro-9.2/idat")
        if cache_dir:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--binary", default="/home/REDACTED/Downloads/ida-pro-mcp/tests/data/test_binary.exe")

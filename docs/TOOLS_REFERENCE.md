...
Compare decompiled functions from two IDA sessions, with optional normalization of function-name, autogenerated-address, and whitespace noise. Numeric constants are preserved so security-relevant bound and mask changes remain visible.
...
```json
{
  ...
  "properties": {
    "left_session": {
      "type": "string",
      "description": "Session ID for the baseline function."
    },
    "left_address": {
      "type": "string",
    ...
    "right_session": {
      "type": "string",
      "description": "Session ID for the candidate function."
    },
    "right_address": {
      "type": "string",
      "description": "Function name or hexadecimal address, for example 0x401000."
    ...
    "normalize": {
      "type": "boolean",
      "description": "Normalize IDA naming and whitespace noise; defaults to true."
    },
    "context_lines": {
      "type": "integer",
      "minimum": 0,
    ...
    "max_diff_lines": {
      ...
      "minimum": 1,
      "maximum": 2000,
      "description": "Maximum diff lines returned; defaults to 400."
    }
  },
  "required": [
    "left_session",

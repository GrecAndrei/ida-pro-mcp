...
## What It Does
Provides built-in documentation search and reading for `docs/wiki`, with ranked search, fuzzy topic resolution, section extraction, related-topic hints, and paginated reads.

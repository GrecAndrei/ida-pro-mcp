...
This project is Alpha (`1.0.0a2`) — see [GitHub Releases](https://github.com/GrecAndrei/ida-pro-mcp/releases) for artifacts and release notes. It exposes 108 deterministic, strict-schema `ida_*` operations supporting Hex-Rays decompilation, cross-session comparison, cross-references, type management, firmware detection, and multi-agent configuration across 22+ coding tools.

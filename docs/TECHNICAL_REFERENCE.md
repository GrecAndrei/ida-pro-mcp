...
- `TOOLS` — ordered list of all 66 tool names
- `ADVERTISED_TOOLS` — 63 tools shown in `tools/list`
- `HIDDEN_TOOLS_IN_LIST` — 3 tools callable via alias/name but hidden from listings

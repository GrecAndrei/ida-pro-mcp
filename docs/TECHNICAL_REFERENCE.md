...
- `TOOLS` — ordered list of all 131 tool names
- `ADVERTISED_TOOLS` — 28 tools shown in `tools/list`
- `HIDDEN_TOOLS_IN_LIST` — 103 tools callable via alias/name but hidden from listings

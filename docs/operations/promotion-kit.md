...
101 strict-schema operations: decompilation, cross-references, raw-binary inspection,
...
default surface currently exposes 101 strict-schema `ida_*` operations covering

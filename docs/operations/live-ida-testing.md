...
| --- | --- | --- |
| `test_agent_surface_live.py` | 10 | Session lifecycle, indexing (incl. the full background decompile index), semantic search, single-function and whole-session binary diffing, and continuation tokens. The original live suite. |

...
TOOLS = [
    "session", "bookmarks", "batch", "analysis", "idb", "code", "data", "search", "types", "memory", "modify",
    "misc", "debug", "funcs", "segments", "project", "plugins", "trace",
    ...
    "imports_deep", "comments_ai", "nav", "colorize",
...
TOOL_DESCRIPTIONS = {
    ...
    "data": "Database queries. Actions: functions, globals, strings, imports, exports, lookup, bulk_query.",
    "search": "Byte and pattern discovery. Actions: bytes, string, immediate, name, insns, text, operand, comment, data_ref, code_ref. Supports offset/limit.",
    ...
    "modify": "Database annotation and manipulation. Actions: rename, comment, set_type, patch, patch_asm.",
    ...
    "funcs": "Function lifecycle management. Actions: create, delete, set_flags, set_name, add_comment, list, info.",
    "segments": "Memory segment management. Actions: list, add, delete, set_attr, set_perms, move.",
    ...
    "fixups": "Relocation management. Actions: list, get, add, delete.",
    "data_ops": "Data definition operations. Actions: make_data, make_array, make_string, undefine, make_code.",
    ...
    "bulk": "Batch database modifications. Actions: rename, comment, apply_type, rename_stack, import_annotations, export_annotations.",
    "ctree": "Hex-Rays AST analysis. Actions: get, traverse, find_calls, find_vars, get_logic_flow.",
    "diff": "Differential analysis. Actions: functions, bytes, signatures.",
    "lumina": "Lumina server interaction. Actions: pull, push, status, history.",
    "symbols": "Symbol management. Actions: load_pdb, load_dwarf, status, apply, export.",
    "patterns": "Binary signature management. Actions: generate, match, list_sigs, apply_sig.",
    "structs": "Structure recovery. Actions: recover, analyze_usage, list, create, add_member, apply, reconstruct_vtable.",
    "strings_xref": "Advanced string analysis. Actions: analyze, xref_chain, detect_encoded.",
    "entropy": "Entropy analysis. Actions: section, packed_detect, crypto_detect.",
    "imports_deep": "Import resolution. Actions: thunks, delay, forwarded, resolve.",
    ...
    "taint": "Static data flow analysis. Actions: find_arg_usage, find_sinks, trace_return, slice.",

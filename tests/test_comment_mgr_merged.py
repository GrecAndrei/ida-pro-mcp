...
def test_tools_reference_doc_canonical_count_drops_to_71():
    """The 'Current canonical tool surface' line now reads 71 tools."""
    text = _read(
        os.path.join(
            os.path.dirname(__file__),
            "..", "docs", "TOOLS_REFERENCE.md",
...
def test_technical_reference_doc_counts_drop():
    """The technical reference doc updates tool count to 71 and
    ADVERTISED to 65."""
    text = _read(
        os.path.join(
            os.path.dirname(__file__),

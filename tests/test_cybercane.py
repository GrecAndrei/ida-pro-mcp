...
Run with: python3 -m pytest tests/test_cybercane.py -v
Or standalone: python3 tests/test_cybercane.py
"""
...
# Load cybercane module via importlib to avoid shadowing stdlib 'types'
_cybercane_path = os.path.join(
    os.path.dirname(__file__), "..",
    "src", "ida_pro_mcp", "ida_mcp", "tools", "cybercane.py"
)
_spec = importlib.util.spec_from_file_location("_cybercane_test_mod", _cybercane_path)
_cybercane = importlib.util.module_from_spec(_spec)
sys.modules["_cybercane_test_mod"] = _cybercane
_spec.loader.exec_module(_cybercane)

CyberCaneGovernance = _cybercane.CyberCaneGovernance
OperationType = _cybercane.OperationType
Severity = _cybercane.Severity
Verdict = _cybercane.Verdict
evaluate_operation = _cybercane.evaluate_operation
list_rules = _cybercane.list_rules
redact_pii = _cybercane.redact_pii
get_governance = _cybercane.get_governance

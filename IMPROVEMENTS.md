...
46. **8000+ Line File**: `api_consolidated.py` is over 8000 lines - extremely difficult to maintain.

47. **Duplicated Logic**: The same xref enumeration code appears in multiple tools.

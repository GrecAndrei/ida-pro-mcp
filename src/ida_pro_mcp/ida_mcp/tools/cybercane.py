#!/usr/bin/env python3
"""
CyberCane Neuro-Symbolic Governance Layer for IDA Pro MCP.
...
Inspired by CyberCane (arXiv:2604.23563) — zero ML, zero external APIs,
zero non-standard dependencies. Uses only Python standard library (re, json).

Integration:
    from .cybercane import get_governance, evaluate_operation

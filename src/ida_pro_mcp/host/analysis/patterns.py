...
# ----------------------------------------------------------------------------
# Shared byte-analysis helpers (entropy / "looks like code"). Pure bytes, no
# disassembly: used only as a bounded raw-blob plausibility flag. Architecture
# and instruction interpretation remain with Jev advisory questions and IDA.
# ----------------------------------------------------------------------------
...
class GlobalFactsDatabase:
    ...
    Integration:
        - Structural metadata is indexed alongside deterministic signatures.

...
TOOL_DESCRIPTIONS = {
    ...
    "firmware_view": "Raw firmware view-shaping assistant. Actions: scan_region, region_profile, segment_sweep, campaign, pointer_sweep, pointer_clusters, table_candidates, carve_plan, auto_retype, smart_carve, recommend, rollback_last, review_contradictions. Integrates memrl + blackboard suggestions for iterative code/data reinterpretation and firmware triage planning. Typical start: firmware_view(action='segment_sweep') then firmware_view(action='campaign', start='0x...', end='0x...').",
...
TOOL_ACTIONS = {
    ...
    "firmware_view": ["scan_region", "region_profile", "segment_sweep", "campaign", "auto_retype", "pointer_sweep", "pointer_clusters", "table_candidates", "carve_plan", "smart_carve", "recommend", "rollback_last", "review_contradictions"],

...
TOOL_DESCRIPTIONS = {
    ...
    "blackboard": "Persistent working memory store for findings, hypotheses, and evidence across sessions. Actions: write, read, list, search, update, delete, clear, stats, prune, merge, contradict, resolve, next_target, start_crawler, stop_crawler, crawler_status, accept, reject, add_evidence, calibrate, campaign_summary, auto_tag_propagate, accept_proposal, reject_proposal.",

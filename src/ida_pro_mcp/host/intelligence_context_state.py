"""
ContextAssembler state / behavior mixin.

This file holds the large post-init body of ContextAssembler so the main
intelligence_context module stays readable and easier to navigate.
"""
...
class ContextAssemblerStateMixin:

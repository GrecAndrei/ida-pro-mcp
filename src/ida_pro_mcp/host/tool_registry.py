...
_TOOL_ACTIONS: dict[str, list[str]] = {
    ...
    "analysis": [
        "plugin_run", "get_options", "set_options", "set_processor",
    ...
    "code": ["smart_decompile", "decompile", "disasm", "analyze", "decompile_chain", "semantic_decompile", "diff_functions", "annotate", "xrefs_to", "xrefs_from", "callees", "callers", "blocks", "callgraph", "find_paths", "strings_in_func", "decomp_dataflow", "export"],
    ...
    "funcs": ["create", "delete", "set_flags", "info", "metrics", "find_similar", "suggest_names"],
    ...
    "idb": ["meta", "summary", "segments", "entrypoints", "bookmarks", "overview", "architecture_profile"],
    ...
    "misc": ["python", "idc", "load_sig", "cache_stats", "plugin_list"],
...
def all_tools() -> list[str]:
    return list(_TOOL_ACTIONS.keys())
...
def tool_action_names(tool: str) -> list[str]:
    return _TOOL_ACTIONS.get(tool, [])


def has_tool(tool: str) -> bool:
    return tool in _TOOL_ACTIONS

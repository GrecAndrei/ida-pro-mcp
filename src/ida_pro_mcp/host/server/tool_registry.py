...
_TOOL_ACTIONS: dict[str, list[str]] = {
    ...
    "code": ["smart_decompile", "decompile", "disasm", "decompile_chain", "semantic_decompile", "diff_functions", "xrefs_to", "xrefs_from", "callees", "callers", "blocks", "callgraph", "find_paths", "strings_in_func", "decomp_dataflow", "export"],

...
TOOL_DESCRIPTIONS = {
    ...
    "truncation": "Continues a previously truncated tool response to retrieve remaining output. Also usable as per-call params on any tool: no_truncate=true skips truncation, max_tokens=N overrides budget, trunc_offset/trunc_limit paginate truncated content directly. Actions: continue.",

...
TOOL_DESCRIPTIONS = {
    ...
    "turboquant": "Compatibility wrapper over the intelligence-backed function embedding index for fast semantic similarity queries over binary artifacts. Actions: ingest, query, stats, delete.",
